...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		ActualCapacity = 1500000
	WHERE TypeID = 1 And ConsumableID = 1;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 6;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1500000,
		ActualCapacity = 1500000
	WHERE TypeID = 1 And ConsumableID = 2;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 7;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1500000,
		ActualCapacity = 1500000
	WHERE TypeID = 1 And ConsumableID = 3;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 8;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		StatusID = 1,  
		OperationStatusID = 0,
		AvailableCapacity = 3000000,
		ActualCapacity = 3000000
	WHERE TypeID = 1 And ConsumableID = 4;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 9;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1500000,
		ActualCapacity = 1500000
	WHERE TypeID = 1 And ConsumableID = 10;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 14;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1500000,
		ActualCapacity = 1500000
	WHERE TypeID = 1 And ConsumableID = 11;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 15;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 3000000,
		ActualCapacity = 3000000	
	WHERE TypeID = 1 And ConsumableID = 12;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0	
	WHERE TypeID = 1 And ConsumableID = 16;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 3000000,
		ActualCapacity = 3000000	
	WHERE TypeID = 1 And ConsumableID = 13;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 0,
		ActualCapacity = 0
	WHERE TypeID = 1 And ConsumableID = 17;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		StatusID = 1,  
		OperationStatusID = 0,
		AvailableCapacity = 1100000,
		ActualCapacity = 1100000	
	WHERE TypeID = 1 And ConsumableID = 18;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1100000,
		ActualCapacity = 1100000	
	WHERE TypeID = 1 And ConsumableID = 19;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1100000,
		ActualCapacity = 1100000	
	WHERE TypeID = 1 And ConsumableID = 20;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1100000,
		ActualCapacity = 1100000	
	WHERE TypeID = 1 And ConsumableID = 21;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		AvailableCapacity = 1100000, 
		ActualCapacity = 1100000
	WHERE TypeID = 1 And ConsumableID = 22;
...
UPDATE Consumables_Details  
	SET InstallationDate = GETDATE(), 
		...
		ActualCapacity = 5000	
	WHERE TypeID = 2 And ConsumableID = 4;
GO
